...
mix.js('resources/assets/js/app.js', 'public/js/app.js')
  .combine([
    ...
    .sass('resources/assets/sass/colors/scp.scss', 'public/css/colors')
    .browserSync('cpl-check-saas-admin')                     // this is the alias/virtual host which will be called to load http://localhost:3000
    .webpackConfig({
