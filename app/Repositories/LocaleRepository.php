...
class LocaleRepository
{
    ...
    /**
     * Download json files containing all words for translation.
     *
     * @return array
     */
    public function download(){
        ...
        foreach($this->getAppLocaleModules() as $module){
            $words = \File::getRequire(getAppPath('resources/lang/en/'.$module.'.php'));
     ...
     * @return array
     */
    private function getAppLocaleModules()
    {
        $modules = array();
        foreach (\File::allFiles(getAppPath('resources/lang/en')) as $file) {
            $modules[] = basename($file, '.php');
        }
