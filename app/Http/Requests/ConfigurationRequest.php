...
class ConfigurationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'subscription_paypal_client_id' => 'sometimes|required_if:subscription_paypal,1',
            'subscription_paypal_client_secret' => 'sometimes|required_if:subscription_paypal,1',
            'subscription_stripe_publishable_key' => 'sometimes|required_if:subscription_stripe,1',
            'subscription_stripe_private_key' => 'sometimes|required_if:subscription_stripe,1',
            'trial_period_days' => 'required_if:enable_trial_period,1|numeric|min:1',
            'website' => 'sometimes|required|url',
            'subscription_invoice_prefix' => 'sometimes|required',
            'subscription_invoice_number_digit' => 'sometimes|required|numeric|min:1',
            'subscription_invoice_start_number' => 'sometimes|required|numeric|min:1'
        ];
    }
    ...
    public function attributes(){
        return [
            ...
            'subscription_paypal_client_id' => 'Paypal Client Id',
            'subscription_paypal_client_secret' => 'Paypal Client Secret',
            'subscription_stripe_publishable_key' => 'Stripe Publishable Key',
            'subscription_stripe_private_key' => 'Stripe Private Key',
            'subscription_invoice_prefix' => trans('configuration.subscription_invoice_prefix'),
            'subscription_invoice_number_digit' => trans('configuration.subscription_invoice_number_digit'),
            'subscription_invoice_start_number' => trans('configuration.subscription_invoice_start_number'),
        ];
    }
}
