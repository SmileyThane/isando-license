...
class ConfigurationController extends Controller
{
    ...
    public function __construct(Request $request, ConfigurationRepository $repo, ActivityLogRepository $activity, LocaleRepository $locale)
    {
        ...
        $this->middleware('prohibited.test.mode')->only(['store','uploadLogo','removeLogo']);
    }
    ...
    public function getConfigurationVariable()
    {
        ...
        return $this->success(compact('color_themes', 'directions', 'date_formats', 'time_formats', 'notification_positions', 'timezones', 'locales'));
    }
