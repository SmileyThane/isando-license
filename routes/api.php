...
Route::group(['middleware' => ['jwt.auth']], function () {
    ...
    Route::get('/plan/pre-requisite','PlanController@preRequisite');
    ...
    Route::patch('/subscriber/{id}','SubscriberController@update');
    Route::delete('/subscriber/{id}','SubscriberController@destroy');

    Route::get('/instance','InstanceController@index');
    Route::get('/instance/{id}','InstanceController@show');
    Route::patch('/instance/{id}','InstanceController@update');
    Route::delete('/instance/{id}','InstanceController@destroy');

    Route::get('/subscription','SubscriptionController@index');
    Route::get('/subscription/{uuid}','SubscriptionController@show');
